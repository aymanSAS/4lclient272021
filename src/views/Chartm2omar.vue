...
<div>
  ...
  <!-- <p style="border:3px;font-size:30px; border-style:solid; border-color:#FF0000; padding: 1em;">
   {{PEI *100 |formatNumber}}  %
...
<!-- <img src="images/LOGOTYMANDMOBIL.png" width="200" height="200" > -->
    </div>
 ...
 <div class="container" style="margin-top: 10px;">
    <div class="row">
      ...
      Product in Batch :
      <br>
      {{(currentbatch[0].ppdbatchcount || 0)| formatNumber}} Unit
      <br>
...
.redstyle {
     color:rgb(255, 0, 0);
     font-size: 35px;
      border-style:solid; border-color:#484952; padding: 7px;
       border-width: 5px;
}
