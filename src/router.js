...
export const router = new Router({
  ...
  routes: [
    ...
    {
      path: "/managermessages-manual",
      name: "managermessages-manual",
      // lazy-loaded
      component: () => import("./views/Managermessages-manual.vue")
    },
    {
      path: "/managermessages-tot",
      name: "managermessages-tot",
      // lazy-loaded
      component: () => import("./views/Managermessages-tot.vue")
    },
    {
      path: "/managermessages-rates",
      name: "managermessages-rates",
      // lazy-loaded
      component: () => import("./views/Managermessages-rates.vue")
    },
    ////////////////////////////////
    {
      path: "/assets",
