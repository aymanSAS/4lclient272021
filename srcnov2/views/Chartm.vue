...
<hr>
<span style="color:blue"> Total Time      : {{TotalTime}}  Hours</span>
<hr>
<span style="color:red"> Failure Time     : {{ftime}} Hours   </span>
<!-- <span style="color:red">  {{ftime}}/{{TotalTime}} %   </span> -->

<hr>
<span style="color:blue"> Maintenance Time : {{mtime}} Hours</span>
<hr>
<span style="color:red">  Other Time       :{{otime}}  Hours</span>
